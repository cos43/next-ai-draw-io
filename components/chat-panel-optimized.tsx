...
import { AutoRepairBanner } from "@/features/chat-panel/components/auto-repair-banner";
        ...
        <Card className="relative flex h-full min-h-0 flex-col gap-0 rounded-none py-0">
            ...
            <CardContent className="flex flex-1 min-h-0 flex-col px-3 pb-3 pt-2">
                <div className="flex flex-1 min-h-0 flex-col gap-3">
                    ...
                    />
                    <AutoRepairBanner state={autoRepairState} />
                    <div className="relative flex-1 min-h-0">
                        ...
                        <div className="h-full overflow-hidden rounded-xl bg-white/90 px-2 py-2">
                            <ChatMessageDisplay
                                messages={messages}
                                error={error}
                                setInput={setInput}
